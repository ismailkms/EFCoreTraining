...
//Burada Order ları Employee lar çağırılmadan önce belleğe aldığı için Employee lar çağırıldığında Employes.Iclude(e => e.Orders) komutunu yazmış gibi davranıp employees lar içerisinde ilişkisel olan orders ları getirir.
#endregion
