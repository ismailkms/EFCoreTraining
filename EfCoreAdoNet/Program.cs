...
#endregion
#region SqlQuery
//SqlQuery fonksiyonu her ne kadar erişilebilir olsada artık desteklenmemektedir. Bunun yerine DbSet propertysi üzerinden erişilebilen FromSql fonksiyonu gelmiştir/kullanılmaktadır.
#endregion
#region SqlQueryRaw
//SqlQueryRaw fonksiyonu her ne kadar erişilebilir olsada artık desteklenmemektedir. Bunun yerine DbSet propertysi üzerinden erişilebilen FromSqlRaw fonksiyonu gelmiştir/kullanılmaktadır.
#endregion
...
class ApplicationDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("server=localhost\\SQLEXPRESS;database=ApplicationDb;integrated security=true;TrustServerCertificate=True");
    }
}