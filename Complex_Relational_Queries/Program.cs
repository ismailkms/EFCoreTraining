...
#region Right Join
//EF core da right join işlemi yapamıyoruz. Onun yerine left join mantığını right joine uyguluyoruz.(Yani ilk tabloyla ikinci tablonun yerini değiştiriyoruz)
...
#region Full Join
//Ef Core da full join yapamıyoruz ama hem right hem de left joini çekip union ile birleştirerek full join mantığını gerçekleştirebiliyoruz.
