...
#region ToListAsync
//Üretilen sorguyu execute(çalıştırmamızı/uygulamamızı) ettirmemizi sağlayan fonksiyondur.
...
#region OrderBy
//Sorgu üzerinde sıralama yapmamızı sağlayan bir fonksiyondur. (Ascending/Artan)
...
//Descending(Azalan) olarak sıralama yapmamızı sağlayan bir fonksiyondur.
...
//OrderByDescending üzerinde yapılan sıralama işlemini farklı kolonlarada uygulamamızı sağlayan bir fonksiyondur.
