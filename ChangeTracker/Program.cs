...
//Yapılan değişikliklerin veritabanına gönderilmeden önce algılandığından emin olmak gerekir. SaveChanges fonksiyonu çağrıldığı anda nesneler EF Core tarafından otomatik kontrol edilirler.(Yani SaveChanges içerisinde DetectChanges otomatik olarak çalıştırılıyor)
...
public class ETicaretContext : DbContext
{
    ...
    public override Task<int> SaveChangesAsync(CancellationToken cancellationToken = default)
    {
        ...
        foreach (var entry in entries)
        {
            ...
            {
                // Örn. ChangeTracker Interceptor yöntemi ile tabloya ilgili kaydın kayıt tarihi, güncelleme tarihi, silinme tarihi gibi verilerin otomatik olarak kaydedilmesi sağlanabilir
            }
        }
