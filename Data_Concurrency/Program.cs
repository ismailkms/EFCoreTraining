...
#endregion
#region Pessimistic Lock (Kötümser Kilitleme) - Tavsiye edilmez
...
#region Property Based Configuration (ConcurrencyCheck Attribute - IsConcurrencyToken Fluent API )
...
#endregion
#region RowVersion Column (Timestamp Attribute - IsRowVersion Fluent API)
//Bu yaklaşımda ise veritabanındaki her bir satıra karşılık versiyon bilgisi fiziksel olarak oluşturulmaktadır.
//Property byte[] dizisi olarak oluşturulmalıdır.
//var person = await context.Persons.FindAsync(3);
//context.Entry(person).State = EntityState.Modified;
//await context.SaveChangesAsync();
#endregion
